[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(CoinEXR.Admin.MVCGridConfig), "RegisterGrids")]

namespace CoinEXR.Admin
{
    using System;
    using System.Web;
    ...
    {
        public static GridDefaults GridDefaults
        {
            get
            {
                return new GridDefaults()
                { Filtering = true, ItemsPerPage = 10, Paging = true, AllowChangingPageSize = true, Sorting = true, };
            }
        }
        public static ColumnDefaults ColumnDefaults
        {
            get
            {
                return new ColumnDefaults() { AllowChangeVisibility = true, EnableFiltering = true, EnableSorting = true };
            }
        }
