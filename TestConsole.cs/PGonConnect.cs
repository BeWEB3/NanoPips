...
namespace PolygonWeb
{
	public class PolygonWebConnect
	{
		...
		public void Start( string Message = "Starting Polygon..." )
		{
			...
			this.websocket = new WebSocket(PGonSocketUrl, sslProtocols: SslProtocols.Tls12 | SslProtocols.Tls11 | SslProtocols.Tls);
		...
		private void websocket_Opened( object sender, EventArgs e )
		{
            ...
            this.websocket.Send("{\"action\":\"auth\",\"params\":\"918UvuvMbGGA5QTt0gNgCLn46X_xnl6_ghwHoS\"}");
            this.websocket.Send("{\"action\":\"subscribe\",\"params\":\"XQ.BTC-USD\"}");
